  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden relative">
      ...
      <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-white/80 backdrop-blur-sm z-10">
        <div>
          <h2 className="text-xl font-bold text-mavenir-dark tracking-tight">3GPP RAG Assistant</h2>
          <p className="text-sm text-gray-500 font-medium">Telco-first. Cloud-native. AI-by-design.</p>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-2 bg-mavenir-light/30">
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center px-4">
            ...
            <h3 className="text-lg font-semibold text-mavenir-dark mb-2">Welcome to the 3GPP RAG Chatbot</h3>
            <p className="text-gray-500 max-w-md">
              Ask me anything about the indexed 3GPP specifications. I'll provide answers grounded directly in the text, complete with citations.
            </p>
          </div>
        ) : (
          messages.map((msg) => (
      ...
      <div className="p-4 bg-white border-t border-gray-100">
        ...
        <div className="text-center mt-3">
          <span className="text-xs text-gray-400">
            Answers are generated by AI and grounded in provided 3GPP documents.
          </span>
        </div>
      </div>
    </div>
