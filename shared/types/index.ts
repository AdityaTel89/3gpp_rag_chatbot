...
export interface Citation {
  ...
  /** Version of the spec, e.g. "17.4.0" */
  specVersion: string;
...
export interface QueryResponse {
  ...
  /**
   * References mentioned in the matched clauses that were NOT found in the database.
   */
  unresolvedReferences?: { specId: string; clauseNumber: string }[];

  /**
   * Claims that were generated by the LLM but failed the secondary entailment check.
   */
  flaggedClaims?: { text: string; reason: string }[];
}
